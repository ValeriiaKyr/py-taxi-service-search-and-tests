...
class FormsTest(TestCase):
    def setUp(self):
        self.manufacturer1 = Manufacturer.objects.create(name="test", country="testcountry")
        self.manufacturer2 = Manufacturer.objects.create(name="another", country="anothercountry")

        self.car1 = Car.objects.create(model="test", manufacturer=self.manufacturer1)
        self.car2 = Car.objects.create(model="another", manufacturer=self.manufacturer2)

        self.driver1 = Driver.objects.create_user(username="testuser", password="pass12345", license_number="ABC12345")
        self.driver2 = Driver.objects.create_user(username="another", password="pass12345", license_number="XYZ56789")
    ...
    def test_drivers_search_form(self):
        ...
        result = Driver.objects.filter(username__icontains=form.cleaned_data["username"])
